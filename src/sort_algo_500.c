...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/02/28 00:57:57 by eassofi           #+#    #+#             */
/*   Updated: 2022/03/06 23:45:53 by eassofi          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sort_algo500(t_list **a, t_list **b, int len)
{
	...
	max = 0;
	sort_algo500_part1(a, b, len);
	sort_algo500_part2(a, b, len);
	sort_algo500_part3(a, b, max);
}
